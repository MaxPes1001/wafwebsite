...
if(isset($_POST['logi']))
{
    ...
    $usern = $_POST['usernam'];
$db_res = mysqli_query($link,"SELECT `User` FROM `TeamLogin` WHERE `User` = '".$usern."'");
...
$pwresold = $row["User"];
  ...
  <?php
    ...
    $pwmd5 = md5($pw);
    $rng = $_POST['ran'];
    mysqli_query($link,"INSERT INTO `TeamLogin`(`User`, `PW`, `Rang`) VALUES ('".$usern."','".$pwmd5."','".$rng."')");
